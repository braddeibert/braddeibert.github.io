...
export default {
  ...
  data() {
    return {
      ...
      contacts: [
        { icon: "github", link: "https://github.com/braddeibert" },
        {
          icon: "linkedin",
          link: "https://www.linkedin.com/in/bradleydeibert/"
        },
        {
          icon: "instagram",
          link: "https://www.instagram.com/bradleydeibert/"
        },
        { icon: "mail", link: "mailto:bradeibert7@gmail.com" }
      ]
    };
  }
};
